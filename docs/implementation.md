...
| Settings | Persistent installation preferences for model, OpenAI-compatible endpoint, assessment interval/global pause, timeout and all three prompts; model discovery and explicit connection test; available without a vehicle; optimistic settings revisions |
